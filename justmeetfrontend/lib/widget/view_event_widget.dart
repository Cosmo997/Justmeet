...
class ViewEvent extends StatefulWidget{
  ...
  Widget build(BuildContext context) {
    if(page == "favo"){
      return Scaffold(
    body: FutureBuilder(
      future: eventoController.loadPreferitiByUtente(idUser),
                                ...
                                children: <Widget>[
                                  ListTile(
                                    ...
                                    trailing: GestureDetector(
                                      onTap: () {
                                        ...
                                        showDialog(
                                                    ...
                                                    builder: (BuildContext context) {
                                                      // return object of type Dialog
                                                      return AlertDialog(
                                                        title: new Text("Evento cancellato con successo"),
                                                        actions: <Widget>[
                                                          // usually buttons at the bottom of the dialog
                                                          new FlatButton(
                                                            child: new Text("Close"),
                                      ...
                                      child: Icon(Icons.delete_forever, color: ThemeHandler.jmTheme().accentColor))
                                  ),
                                   Divider(indent: 30, endIndent: 30, height: 10, thickness: 2,),
                                   Text("Descrizione", style: TextStyle(fontSize: 18), ),
                                   Container(
    ...
    }else if(page == "sub")
    {
      return Scaffold(
    body: FutureBuilder(
      future: eventoController.loadEventiWhereUserIsSub(AuthProvider.getUId()),
      builder: (BuildContext context, AsyncSnapshot<List<Evento>> snapshot) {
        if(snapshot.data == null)
        {
          return LoadingWidget();
